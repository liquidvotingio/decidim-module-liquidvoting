...
Decidim::Proposals::Proposal.class_eval do
  ...
  # The original Decidim::Proposals::Proposal uses a :counter_cache on the ProposalVote model,
  # which we've abandoned. The :proposal_votes_count attribute is now completely managed
  # by Liquidvoting.
